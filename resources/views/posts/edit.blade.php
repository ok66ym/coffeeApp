            ...
            <div class="flex flex-col justify-center items-center min-h-screen bg-orange-100">
                ...
                <div class="flex flex-col justify-center items-center border border-orange-900 rounded p-8 w-3/5 md:w-1/2 lg:w-3/5 relative">
                    ...
                    <div class="absolute top-0 left-0 mt-2 ml-2">
                        <a href="/posts/{{ $post->id }}" class="text-1xl bg-orange-300 text-gray-800 hover:text-black hover:bg-orange-400 focus:border-orange-400 font-bold py-1 px-4 border border-orange-300 rounded cursor-pointer no-underline">
                            戻る
                        </a>
                    </div>
                    ...
                    <div class="flex justify-center mb-4">
                        <button id="show-popup" class="px-4 py-2 bg-orange-300 text-gray-800 hover:text-black hover:bg-orange-400 focus:border-orange-400 font-bold border-orange-300 rounded cursor-pointer z-100">投稿について</button>
                    </div>
                    ...
                    <div id="popup" class="fixed top-0 left-0 bg-black bg-opacity-50 hidden flex justify-center items-center mb-5 z-100 relative">
                        ...
                        <form action='/posts/{{ $post->id }}' method="POST">
                            ...
                            <div class="flex items-center mb-4">
                                <input class ="shadow-autofill focus:ring-2 focus:ring-orange-900 focus:border-orange-900 mr-4 bg-orange-100 border-0 border-b border-orange-800 w-96" type="text" name="post[name]" placeholder="コーヒー名" value="{{ $post->name }}"/>
                            </div>
                            <p class="name_error" style="color:red">{{ $errors->first('post.name') }}</p>
                            
                            <!--コーヒー種名を記録-->
                            <div class="flex items-center mb-4">
                                <input class ="shadow-autofill focus:ring-2 focus:ring-orange-900 focus:border-orange-900 mr-4 bg-orange-100 border-0 border-b border-orange-800 w-96" type="text" name="post[species_name]" placeholder="コーヒー種名" value="{{ $post->species_name }}"/>
                            </div>
                            <p class="species_name_error" style="color:red">{{ $errors->first('post.species_name') }}</p>
                            
                            <!--コーヒーの産地を記録-->
                            <div class="posts_areaName">
                                <input class ="shadow-autofill focus:ring-2 focus:ring-orange-900 focus:border-orange-900 mr-4 bg-orange-100 border-0 border-b border-orange-800 w-96" type="text" name="post[area_name]"　placeholder="産地" value="{{ $post->area_name }}"/>
                            </div>
                            <p class="area_name_error" style="color:red">{{ $errors->first('post.area_name') }}</p>
                            
                            <!--販売・購入店を記録-->
                            <div class="flex items-center mt-2 mb-2">
                                <input class ="shadow-autofill focus:ring-2 focus:ring-orange-900 focus:border-orange-900 mr-4 bg-orange-100 border-0 border-b border-orange-800 w-96" type="text" name="post[shop_name]" placeholder="販売店" value="{{ $post->shop_name }}"/>
                            </div>
                            <p class="shop_name_error" style="color:red">{{ $errors->first('post.shop_name') }}</p>
                            
                            <!--コーヒー販売元のurlを記録-->
                            <div class="flex items-center mb-4">
                                <input class ="shadow-autofill focus:ring-2 focus:ring-orange-900 focus:border-orange-900 mr-4 bg-orange-100 border-0 border-b border-orange-800 w-96" type="text" name="post[shop_url]" placeholder="販売元URL https://~~~" value="{{ $post->shop_url }}"/>
                            </div>
                            ...
                            <div class="flex items-center mt-8 mb-5">
                                ...
                                <div class="slider-container relative w-96">
                                    <input type="range" id="postbitter" min="1" max="5" step="0.5" name="post[bitter]" value="{{ old('post.bitter', $post->bitter ?? 3) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 h-2 rounded-full">
                            ...
                            <div class="flex items-center mt-7 mb-5">
                                ...
                                <div class="slider-container relative w-96">
                                    <input type="range" id="postacidity" min="1" max="5" step="0.5" name="post[acidity]" value="{{ old('post.acidity', $post->acidity ?? 3) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 h-2 rounded-full">
                            ...
                            <div class="flex items-center mt-7 mb-5">
                                ...
                                <div class="slider-container relative w-96">
                                    <input type="range" id="postrich" min="1" max="5" step="0.5" name="post[rich]" value="{{ old('post.ruch', $post->rich ?? 3) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 h-2 rounded-full">
                            ...
                            <div class="flex items-center mt-7 mb-5">
                                ...
                                <div class="slider-container relative w-96">
                                    <input type="range" id="postsweet" min="1" max="5" step="0.5" name="post[sweet]" value="{{ old('post.sweet', $post->sweet ?? 3) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 h-2 rounded-full">
                            ...
                            <div class="flex items-center mt-7 mb-5">
                                ...
                                <div class="slider-container relative w-96">
                                    <input type="range" id="postsmell" min="1" max="5" step="0.5" name="post[smell]" value="{{ old('post.smell', $post->smell ?? 3) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 h-2 rounded-full">
                            ...
                            <!--コーヒー豆の焙煎度を記録-->
                        <div class="flex items-center mb-4">
                            <input class= "shadow-autofill focus:ring-2 focus:ring-orange-900 focus:border-orange-900 mr-4 bg-orange-100 border-0 border-b border-orange-800 w-96" type="text" name="post[roasted]" placeholder="焙煎度" value="{{ $post->roasted }}"/>
                        </div> 
                        <p class="roasted_error" style="color:red">{{ $errors->first('post.roasted') }}</p>
                            
                        <!--投稿するコーヒーについての説明-->
                        <div class="flex items-center mb-4">
                            <textarea class="shadow-autofill focus:ring-2 focus:ring-orange-900 focus:border-orange-900 mr-4 bg-orange-100 border-0 border-b border-orange-800 w-96 h-40" name="post[explanation]" placeholder="コーヒーについて">{{ $post->explanation }}</textarea>
                        </div>
                        ...
                        <div class="flex items-center mb-4 space-x-4">
                            <div class="flex flex-col items-center space-y-4"> <!-- 縦に並べる部分をflex-colで囲む -->
                                ...
                                @if($post->image) <!-- 既存の画像が存在する場合、削除ボタンを表示 -->
                                    <button id="remove-image" type="button" class="text-black hover:underline">写真を削除</button>
                                @else
                                    <button id="remove-image" type="button" class="text-black hover:underline hidden">写真を削除</button>
                                @endif
                            </div>
                            <div id="image-preview" class="w-64 h-64 border border-orange-900 relative mb-4">
            ...
            document.getElementById('image-upload').addEventListener('change', function (e) {
                ...
                if (file && file.type.match('image.*')) {
                    ...
                    reader.onload = function (event) {
                        ...
                        img.classList.add('w-64', 'h-64', 'object-cover', 'rounded'); // Tailwind CSSのクラスを追加
