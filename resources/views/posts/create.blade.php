                    ...
                    <form action="/posts" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="flex items-center mb-4 space-x-4">
                            <div class="flex flex-col items-center space-y-4"> <!-- 縦に並べる部分をflex-colで囲む -->
                                ...
                                <button id="remove-image" type="button" class="text-black hover:underline hidden">写真を削除</button> <!-- ここに移動 -->
                            </div>
                            <div id="image-preview" class="w-64 h-64 border border-orange-900 relative mb-4"></div> <!-- 画像のプレビュー部分 -->
                        </div>
