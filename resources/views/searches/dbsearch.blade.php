                    ...
                    <form action="/search/db/results" method="GET">
                        ...
                        <div class="flex items-center justify-center mt-8 mb-5">
                            ...
                            <div class="slider-container relative lg:w-96 w-60 lg:text-base text-sm">
                                <input type="range" id="dbbitter" min="1" max="5" step="0.5" name="db[bitter]" value="{{ old('db.bitter', session('search_values.bitter', 1)) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 lg:h-2 h-1 rounded-full">
                        ...
                        <div class="flex items-center justify-center mt-7 mb-5">
                            ...
                            <div class="slider-container relative lg:w-96 w-60 lg:text-base text-sm">
                                <input type="range" id="dbacidity" min="1" max="5" step="0.5" name="db[acidity]" value="{{ old('db.acidity', session('search_values.acidity', 1)) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 lg:h-2 h-1 rounded-full">
                        ...
                        <div class="flex items-center justify-center mt-7 mb-5">
                            ...
                            <div class="slider-container relative lg:w-96 w-60 lg:text-base text-sm">
                                <input type="range" id="dbrich" min="1" max="5" step="0.5" name="db[rich]" value="{{ old('db.rich', session('search_values.rich', 1)) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 lg:h-2 h-1 rounded-full">
                        ...
                        <div class="flex items-center justify-center mt-7 mb-5">
                            ...
                            <div class="slider-container relative lg:w-96 w-60 lg:text-base text-sm">
                                <input type="range" id="dbsweet" min="1" max="5" step="0.5" name="db[sweet]" value="{{ old('db.sweet', session('search_values.sweet', 1)) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 lg:h-2 h-1 rounded-full">
                        ...
                        <div class="flex items-center justify-center mt-7 mb-5">
                            ...
                            <div class="slider-container relative lg:w-96 w-60 lg:text-base text-sm">
                                <input type="range" id="dbsmell" min="1" max="5" step="0.5" name="db[smell]" value="{{ old('db.smell', session('search_values.smell', 1)) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 lg:h-2 h-1 rounded-full">
