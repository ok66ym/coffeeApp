        ...
        <div class="pt-20 pb-40">
            ...
            <div class="ml-1 mr-1 flex flex-col justify-center items-center min-h-screen bg-orange-100 relative w-full">
                ...
                <div class="flex justify-center items-center mt-5">
                    <a href='/histories' class="md:text-base text-sm flex justify-center items-center bg-orange-300 text-gray-800 hover:text-black hover:bg-orange-400 focus:border-orange-400 font-bold md:px-4 md:py-2 px-2 py-1 border border-orange-300 rounded cursor-pointer no-underline">
                        検索履歴に戻る
                    </a>
                </div>
            </div>
