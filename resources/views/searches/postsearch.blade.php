            ...
            <div class="flex flex-col justify-center items-center min-h-screen bg-orange-100">
                <div class="flex flex-col justify-center items-center border border-orange-900 rounded lg:p-8 lg:w-3/5 p-2 w-11/12 relative">
                    ...
                    <div class="absolute top-0 left-0 mt-2 ml-2">
                        <a href="/search" class="lg:text-base text-sm bg-orange-300 text-gray-800 hover:text-black hover:bg-orange-400 focus:border-orange-400 font-bold py-1 px-4 border border-orange-300 rounded cursor-pointer no-underline">
                            戻る
                        </a>
                    </div>
                    ...
                    <div class="flex justify-center items-center mb-4 mt-10">
                        <button id="show-popup" class="lg:text-base text-sm ml-8 px-4 py-2 bg-orange-300 text-gray-800 hover:text-black hover:bg-orange-400 focus:border-orange-400 font-bold border border-orange-300 rounded cursor-pointer z-100">ヒント</button>
                    </div>
                
                    <!-- ポップアップの内容 -->
                    <div id="popup" class="fixed top-0 left-0 bg-black bg-opacity-50 hidden flex justify-center items-center mb-5 z-100 relative">
                        <div class="bg-yellow-100 border border-orange-900 p-2 rounded max-w-xl relative">
                            <p class="lg:text-base text-xs">
                                ...
                                <b class="text-sx font-bold text-gray-700">※販売店のデータが削除された場合は，販売店のリンクから販売サイトが表示されない場合があります．
                            </p>
                    ...
                    <form action="/search/posts/results" method="GET">
                        ...
                        <div class="flex items-center justify-center mt-8 mb-5">
                            ...
                            <div class="slider-container relative lg:w-96 w-60 lg:text-base text-sm">
                                <input type="range" id="postbitter" min="1" max="5" step="0.5" name="post[bitter]" value="{{ old('post.bitter', session('search_values.bitter', 1)) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 lg:h-2 h-1 rounded-full">
                        ...
                        <div class="flex items-center justify-center mt-7 mb-5">
                            ...
                            <div class="slider-container relative lg:w-96 w-60 lg:text-base text-sm">
                                <input type="range" id="postacidity" min="1" max="5" step="0.5" name="post[acidity]" value="{{ old('post.acidity', session('search_values.acidity', 1)) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 lg:h-2 h-1 rounded-full">
                        ...
                        <div class="flex items-center justify-center mt-7 mb-5">
                            ...
                            <div class="slider-container relative lg:w-96 w-60 lg:text-base text-sm">
                                <input type="range" id="postrich" min="1" max="5" step="0.5" name="post[rich]" value="{{ old('post.rich', session('search_values.rich', 1)) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 lg:h-2 h-1 rounded-full">
                        ...
                        <div class="flex items-center justify-center mt-7 mb-5">
                            ...
                            <div class="slider-container relative lg:w-96 w-60 lg:text-base text-sm">
                                <input type="range" id="postsweet" min="1" max="5" step="0.5" name="post[sweet]" value="{{ old('post.sweet', session('search_values.sweet', 1)) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 lg:h-2 h-1 rounded-full">
                        ...
                        <div class="flex items-center justify-center mt-7 mb-5">
                            ...
                            <div class="slider-container relative lg:w-96 w-60 lg:text-base text-sm">
                                <input type="range" id="postsmell" min="1" max="5" step="0.5" name="post[smell]" value="{{ old('post.smell', session('search_values.smell', 1)) }}" class="shadow-autofill focus:ring-2 focus:ring-orange-900 bg-orange-100 w-80 lg:h-2 h-1 rounded-full">
                        ...
                        <div class="flex justify-center pl-10">
                            <input class="lg:text-base text-sm bg-orange-300 text-gray-800 hover:text-black hover:bg-orange-400 focus:border-orange-400 font-bold py-2 px-4 border border-orange-300 rounded cursor-pointer" type="submit" value="コーヒーを探す"/>
                        </div>
                    </form>
                </div>
            </div>        
