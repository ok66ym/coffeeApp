    <x-app-layout>
        <div class="pt-20 pb-40">
            ...
            <div class="ml-1 mr-1 flex flex-col justify-center items-center min-h-screen bg-orange-100 relative w-full">
                <!--投稿結果を表示-->
                <h1 class="ml-1 mr-1 md:text-2xl text-lg flex justify-center mt-5 ml-5 border-b-4 border-orange-800 w-96 text-gray-700">
                    検索結果一覧
                </h1>
                ...
                <div class="font-bold text-base mt-5 md:w-10/12">
                    <div class='border-orange-300 flex flex-col justify-center items-center md:w-10/12'>

                        @foreach ($searchstores as $searchstore)
                            <div class="border-t border-b border-orange-300 py-3 flex justify-center items-center md:w-10/12 relative">
                                <div>
                                    ...
                                    <div class="flex items-center space-x-4 mt-2 text-sm">
                                        <div class="searchHistory_index">
                                            <span class="md:text-base text-sm bg-orange-300 text-gray-700 px-1 rounded">苦味</span>{{ $searchstore['bitter'] }}
                                            <span class="md:text-base text-sm bg-orange-300 text-gray-700 px-1 rounded">酸味</span>{{ $searchstore['acidity'] }}
                                            <span class="md:text-base text-sm bg-orange-300 text-gray-700 px-1 rounded">コク</span>{{ $searchstore['rich'] }}
                                            <span class="md:text-base text-sm bg-orange-300 text-gray-700 px-1 rounded">甘味</span>{{ $searchstore['sweet'] }}
                                            <span class="md:text-base text-sm bg-orange-300 text-gray-700 px-1 rounded">香り</span>{{ $searchstore['smell'] }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex justify-center items-center space-x-4 mt-3">
                                        <a href="{{ route('search.redbresults', ['bitter' => $searchstore->bitter, 'acidity' => $searchstore->acidity, 'rich' => $searchstore->rich, 'sweet' => $searchstore->sweet, 'smell' => $searchstore->smell]) }}" 
                                           class="md:text-base text-sm bg-yellow-700 hover:bg-yellow-800 text-white font-bold md:py-2 md:px-4 py-1 px-2 rounded cursor-pointer no-underline">
                                           コーヒーを再検索
                                        </a>
